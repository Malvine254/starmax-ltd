...
/* Keep about page section titles on one line */
.about-one-line {
    white-space: nowrap;
    overflow: hidden;
    ...
    <div class="mv-grid">
        ...
        <article class="mv-card mv-card-vision reveal">
            <div class="mv-card-inner">
                ...
                <h3>Our Vision</h3>
                <p>To become East Africa's most trusted technology partner - known for clean architecture, honest timelines, and software that actually works in production.</p>
            </div>
        </article>
    </div>
</div>
...
<div class="section">
    <div class="section-header">
        ...
        <h2 class="about-one-line">Multiple disciplines, one team.</h2>
...
<div style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:56px 0;">
    <div class="container">
        <div class="section-header" style="margin-bottom:36px;">
            ...
            <h2 class="about-one-line">Core values.</h2>
        ...
        <div class="values-grid">
            <article class="value-card reveal">
                ...
                <div>
                    <h4>Transparency</h4>
                    <p>Clear communication, honest estimates, and auditable deliverables. No black boxes.</p>
                </div>
            </article>
            <article class="value-card reveal">
                ...
                <div>
                    <h4>Reliability</h4>
                    <p>Disciplined timelines, accountable follow-through, and battle-tested deployment practices.</p>
                </div>
            </article>
            <article class="value-card reveal">
                ...
                <div>
                    <h4>Innovation</h4>
                    <p>We apply modern frameworks, AI capabilities, and DevOps practices where they genuinely help.</p>
                </div>
            </article>
            <article class="value-card reveal">
                ...
                <div>
                    <h4>Integrity</h4>
                    <p>We recommend what is right for your business, not what is easiest for us to build.</p>
                </div>
            </article>
        </div>
    </div>
...
<div class="cta-banner reveal">
    <h2 class="about-one-line">Want to work with us?</h2>
    <p>We would love to hear about your project and explore how we can help turn your idea into a production system.</p>
